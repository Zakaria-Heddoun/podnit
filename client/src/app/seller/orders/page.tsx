...
export default function SellerOrders() {
  ...
  const orderCreated = searchParams.get('created') === 'true';
  ...
  const transformApiOrder = (apiOrder: OrderApiResponse): Order => {
    return {
      ...
      customer: {
        ...
        avatar: undefined // Not available from API
      },
        ...
        <div className="rounded-md bg-green-50 p-4 border border-green-200">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-green-700">Your order has been created and is pending processing.</p>
            </div>
          </div>
        </div>
      )}
