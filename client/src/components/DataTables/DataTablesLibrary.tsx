...
export interface DataTablesLibraryItem {
  id: number;
  name: string;
  image: string;
  position: string;
...
interface DataTablesLibraryProps {
  data: DataTablesLibraryItem[];
  title?: string;
}

const DataTablesLibrary: React.FC<DataTablesLibraryProps> = ({ 
  data, 
  title = "Datatable 1" 
}) => {
  ...
  const filteredData = useMemo(() => {
    ...
    return data
      ...
      .sort((a, b) => {
        ...
        const aValue = a[sortColumn as keyof DataTablesLibraryItem];
        const bValue = b[sortColumn as keyof DataTablesLibraryItem];
...
export default DataTablesLibrary;