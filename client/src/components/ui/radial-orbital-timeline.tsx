    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute w-[500px] h-[500px] rounded-full border border-border/20"></div>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    left: `-${(item.energy * 0.7 + 60 - 64) / 2}px`,
                    top: `-${(item.energy * 0.7 + 60 - 64) / 2}px`,
                  }}
                ></div>
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-card/90 backdrop-blur-lg border-border shadow-xl shadow-glow overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-base mt-2 text-card-foreground">
                        {item.title}
                      </CardTitle>
                    </CardHeader>
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-none border-border/20 bg-transparent hover:bg-accent hover:text-accent-foreground transition-all"
                                  onClick={(e) => {
                                    e.stopPropagation();
